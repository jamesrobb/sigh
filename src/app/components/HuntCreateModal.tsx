...
export default function HuntCreateModal({
  statuses,
  triggerLabel = "Create hunt",
  triggerHint = "Press 'c' to add hunt or click",
  enableShortcut = true,
  ...
  }, [enableShortcut, isOpen, statuses]);
